  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (user != null && mounted) {
        ...
        if (widget.selectedUserType != null && user.userType != widget.selectedUserType) {
                ...
                children: [
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      if (widget.selectedUserType != null) ...[
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(
                                widget.selectedUserType == UserType.user
                                    ? Icons.person
                                    : widget.selectedUserType == UserType.therapist
                      ...
                      if (widget.selectedUserType != UserType.admin) ...[
                        const SizedBox(height: 24),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
