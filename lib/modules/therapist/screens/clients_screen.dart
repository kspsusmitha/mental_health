  ...
  Future<void> _loadClients() async {
    ...
    try {
      ...
      for (final clientId in clientIds) {
        ...
        sessionCounts[clientId] = appointments.where((a) => a.userId == clientId).length;
      }
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('No clients yet', style: TextStyle(color: Colors.grey[600])),
                    ],
                  ),
                )
              : RefreshIndicator(
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text('${sessionCount} session${sessionCount != 1 ? 's' : ''}'),
