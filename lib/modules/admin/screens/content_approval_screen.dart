    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(approve ? 'Resource approved' : 'Resource rejected')),
        );
      }
    } catch (e) {
      if (mounted) {
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('No pending content', style: TextStyle(color: Colors.grey[600])),
                    ],
                  ),
                )
              : RefreshIndicator(
